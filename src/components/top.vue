<template>
  <div class="container">
    <div class="main">
      ...
      <img class="mv" src="../assets/MV.png" alt="MV">
    </div>
  </div>
</template>
...
export default {
  ...
  data () {
    return {
      title: 'WHAT I CAN DO.',
      description: `My name is Masayoshi Kawashima,\nas known as ma-ya's CREATE.\nThis site has created by SPA of Vue.js.`
    }
  }
}
</script>
...
span.item:nth-last-child(2),span.item:nth-last-child(3) {
  color : #4BC9C7;
}
@keyframes text-in {
  0% {
